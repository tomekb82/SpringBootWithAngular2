...
@Component({
  ...
  Nazwa
  <i *ngIf="isOrderedBy('name')" 
  class="glyphicon" 
  [ngClass]="{'glyphicon-chevron-up': !isOrderedReverse(), 'glyphicon-chevron-down':isOrderedReverse()}"></i>
</span>
            ...
            <tbody>
                ...
                <tr *ngFor="let album of albums | albumType: this.filterValue | orderBy: ['-name', 'url']; let i = index"
                    class="album-row" 
...
isOrderedReverse() {
  ...
  ngOnInit() {
    this.albumService.getPhotosStream()
